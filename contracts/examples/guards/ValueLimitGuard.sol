...
/**
 * @title ValueLimitGuard - Restricts transactions to a maximum value limit.
 */
contract ValueLimitGuard is BaseGuard {
    ISafe public safe;
     ...
     * @dev Reverts if the transaction value exceeds the maxValue limit.
    ...
    function checkTransaction(
        ...
        require(value <= maxValue, "Transaction value exceeds limit");
